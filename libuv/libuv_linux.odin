...
barrier_t :: distinct sync.Barrier

addrinfo     :: distinct linux.addrin
file         :: distinct c.int
os_sock_t    :: distinct c.int
os_fd_t      :: distinct c.int
pid_t        :: distinct linux.Pid
uid_t        :: distinct linux.Uid
gid_t        :: distinct linux.Gid
thread_t     :: distinct thread.Thread
mutex_t      :: distinct sync.Mutex
sem_t        :: distinct sync.Sema
...
/* None of the above. */ 
env_item_t          :: distinct uv_env_item_s                                        
cpu_info_t          :: distinct uv_cpu_info_s                                        
interface_address_t :: distinct uv_interface_address_s                               
dirent_t            :: distinct uv_dirent_s                                          
passwd_t            :: distinct uv_passwd_s                                          
utsname_t           :: distinct uv_utsname_s                                         
...
//function pointers
alloc_cb         :: distinct proc "c" (handle: ^handle_t, suggested_size: c.size_t, buf: ^buf_t)
close_cb         :: distinct proc "c" (handle: ^handle_t)
walk_cb          :: distinct proc "c" (handle: ^handle_t, arg: rawptr)
timer_cb         :: distinct proc "c" (handle: ^timer_t)
prepare_cb       :: distinct proc "c" (handle: ^prepare_t)
check_cb         :: distinct proc "c" (handle: ^check_t)
idle_cb          :: distinct proc "c" (handle: ^idle_t)
async_cb         :: distinct proc "c" (handle: ^async_t)
poll_cb          :: distinct proc "c" (handle: ^poll_t, status, events: c.int)
signal_cb        :: distinct proc "c" (handle: ^signal_t, signum: c.int)
read_cb          :: distinct proc "c" (stream: ^stream_t, nread: c.ssize_t, buf: ^buf_t)
exit_cb          :: distinct proc "c" (process: ^process_t, exit_status: c.int64_t, term_signal: c.int)
write_cb         :: distinct proc "c" (req: ^write_t, status: c.int)
connect_cb       :: distinct proc "c" (req: ^connect_t, status: c.int)
shutdown_cb      :: distinct proc "c" (req: ^shutdown_t, status: c.int)
connection_cb    :: distinct proc "c" (server: ^stream_t, status: c.int)
udp_send_cb      :: distinct proc "c" (req: ^udp_send_t, status: c.int)
udp_recv_cb      :: distinct proc "c" (handle: ^udp_t, nread: c.ssize_t, buf: ^buf_t, addr: ^windows.sockaddr, flags: c.uint)
fs_event_cb      :: distinct proc "c" (handle: ^fs_event_t, filename: cstring, events, status: c.int)
fs_poll_cb       :: distinct proc "c" (handle: ^fs_poll_t, status: c.int, prev: ^stat_t, curr: ^stat_t)
fs_cb            :: distinct proc "c" (req: ^fs_t)
work_cb          :: distinct proc "c" (req: ^work_t)
after_work_cb    :: distinct proc "c" (req: ^work_t, status: c.int)
getaddrinfo_cb   :: distinct proc "c" (req: ^getaddrinfo_t, status: c.int, res: ^addrinfo)
getnameinfo_cb   :: distinct proc "c" (req: ^getaddrinfo_t status: c.int, hostname, service: cstring)
thread_cb        :: distinct proc "c" (arg: rawptr)
malloc_func      :: distinct proc "c" (size: c.size_t) -> rawptr 
realloc_func     :: distinct proc "c" (ptr: rawptr, size: c.size_t) -> rawptr
calloc_func      :: distinct proc "c" (count, size: c.size_t) -> rawptr
free_func        :: distinct proc "c" (ptr: rawptr)
random_cb        :: distinct proc "c" (req: ^random_t, status: c.int, buf: rawptr, buflen: c.size_t)
